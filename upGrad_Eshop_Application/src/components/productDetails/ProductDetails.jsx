//Progra for reflecting the product details:

// Import all the necessary hooks and components
...
const ProductDetails = () => {
	...
	// Accessing theme object from Material-UI
	...
	// Effect to initialize page data
	useEffect(() => {
		initPageData();
	}, [initPageData]);
