// Program for Product page - Creation and modification

import { useState, useEffect, useCallback, useContext } from "react"; // Importing necessary hooks from React
...
import { useLocation, useNavigate } from "react-router-dom"; // Importing hooks from react-router-dom
...
import CreatableSelect from "../creatableSelect/CreatableSelect"; // Importing CreatableSelect component
...
const ProductPage = ({ categories, mode, headingText, buttonText, callbackFunction, jsonData, reFetchAllData }) => {
  ...
  let json = location.state; // Initializing json variable with state from location
  ...
  const initPageData = useCallback(
    (type = mode, data = json, redirect = navigate, showMessage = broadcastMessage) => {
