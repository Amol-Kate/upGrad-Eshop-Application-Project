// Program for all the Product cards which shows all the product details:
...
const ProductCard = ({mode, deleteProduct, modifyProduct, buyProduct, ...details}) => {
	// Function to truncate text if it exceeds 150 characters
	...
	// Function to render edit and delete buttons based on mode
	let checkAdminMode = () => {
		if (mode === "EDIT") {
			return (
				<>
